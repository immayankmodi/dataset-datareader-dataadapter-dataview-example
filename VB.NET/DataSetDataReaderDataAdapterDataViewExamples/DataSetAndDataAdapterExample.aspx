<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DataSetAndDataAdapterExample.aspx.vb"
    Inherits="DataSetDataReaderDataAdapterDataViewExamples.DataSetAndDataAdapterExample" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>AspnetO.com | Bind Asp.net Gridview using DataSet and DataAdapter Example </title>
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <table>
                <tr>
                    <td colspan="3">
                        <h4>Bind Asp.net Gridview using DataSet and DataAdapter Example
                        </h4>
                    </td>
                </tr>
                <tr>
