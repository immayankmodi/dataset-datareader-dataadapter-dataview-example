<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DataViewExample.aspx.vb"
    Inherits="DataSetDataReaderDataAdapterDataViewExamples.DataViewExample" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>AspnetO.com | Bind Asp.net Gridview using DataView Example example </title>
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <table>
                <tr>
                    <td colspan="3">
                        <h4>Bind Asp.net Gridview using DataView Example
                        </h4>
                    </td>
                </tr>
                <tr>
